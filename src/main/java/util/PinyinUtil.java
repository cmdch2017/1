...
public class PinyinUtil {
    ...
    public static String[][] get(String name,boolean fullSpell){
        ...
        for(int i=0;i<chars.length;i++){
            try {
                String[] pinyins=PinyinHelper//和:[he,易班推文排版hu,huo] 或 bull
...
//字符串数组去重操作
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(get("中华人名共和国")));
        System.out.println(Arrays.toString(get("中华1人b名共A和国")));
